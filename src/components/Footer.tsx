      ...
      <div className="bg-gold py-12">
        <div className="container-custom text-center">
          <h2 className="font-poppins text-3xl md:text-4xl font-bold text-navy mb-4">
            Find the Right Coverage Fast
          </h2>
          <p className="text-navy/80 text-lg mb-6 max-w-2xl mx-auto">
            Get personalized insurance quotes in minutes. No pressure, no obligation.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              First Heritage Insurance Agency is your trusted partner for customized insurance plans. Serving New York, Connecticut, and beyond, we deliver affordable home, auto, and business solutions designed to protect what matters most to you.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-poppins font-semibold text-lg mb-4 text-gold">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-poppins font-semibold text-lg mb-4 text-gold">Our Services</h3>
            <ul className="space-y-2">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-poppins font-semibold text-lg mb-4 text-gold">Contact Us</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300 text-sm">
                  150 Broadhollow Rd, Suite 10<br />
                  Melville, NY 11747
                </span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:631-659-0189" className="text-gray-300 hover:text-gold transition-colors text-sm">
                  631-659-0189
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:service@fhia.net" className="text-gray-300 hover:text-gold transition-colors text-sm">
                  service@fhia.net
                </a>
              </li>
            </ul>
